...
export const CHANNEL_TARGET_DESCRIPTION =
  "Recipient/channel: E.164 for WhatsApp/Signal, Telegram chat id/@username, Discord channel/user, Slack user (by ID/email/username/display name) or channel (by ID/name like #general), or iMessage handle/chat_id";
