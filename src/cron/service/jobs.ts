...
function assertDeliverySupport(job: Pick<CronJob, "sessionTarget" | "delivery">) {
  ...
  if (job.sessionTarget !== "isolated" && job.sessionTarget !== "direct") {
    throw new Error('cron channel delivery config is only supported for sessionTarget="isolated" or "direct"');
  }
}
